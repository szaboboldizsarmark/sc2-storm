function OnPopulate()
	...
	-- Spawn some on-going lava plumes at the volcano
	local lavaSpawnPos = import('/lua/sim/ScenarioUtilities.lua').MarkerToPosition('Center Smoke 01')
	if lavaSpawnPos then
		ForkThread( import('/lua/sim/EffectUtilities.lua').SpawnLavaPlumes, lavaSpawnPos )
	end
end
